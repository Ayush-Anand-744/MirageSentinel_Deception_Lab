...
```bash
cd /home/patrick/Documents/MirageSentinel Deception Lab/scripts/crdt
cargo build --release

# Copy to VM
scp target/release/mirage-crdt vagrant@10.20.20.10:/tmp/mirage-crdt
...
```bash
cd /home/patrick/Documents/MirageSentinel Deception Lab/scripts
...
# On host
cd /home/patrick/Documents/MirageSentinel Deception Lab/scripts/crdt
scp target/release/mirage-crdt /tmp/mirage-crdt
