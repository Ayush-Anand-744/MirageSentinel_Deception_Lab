...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    apt update
    apt install -y nginx openssh-server redis-tools sudo

    # Fake content
    echo "Corp Internal Web Portal" > /var/www/html/index.html
  SHELL
  # 🔑 MirageSentinel identity sync
...
# destroy all VMS:
cd ~/Documents/MirageSentinel Deception Lab/simulations/fake
...
cd ~/Documents/MirageSentinel Deception Lab/simulations/fake/gateway-vm
vagrant destroy -f