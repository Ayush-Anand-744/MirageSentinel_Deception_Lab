...
## 2. miragesentinel_net (Deception Fabric)
The fake world
Honeynet
...
sudo virsh net-define miragesentinel_net.xml

sudo virsh net-start corp_net
sudo virsh net-start miragesentinel_net

sudo virsh net-autostart corp_net
sudo virsh net-autostart miragesentinel_net
```
...
------------------------------------------------------
 ...
 miragesentinel_net          active     yes         yes
...
✔ Mirror corp services into miragesentinel_net
