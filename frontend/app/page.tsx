      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/80 backdrop-blur-xl">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold tracking-tight">MirageSentinel_Deception_Lab</span>
          </div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm mb-8">
              ...
              <span>Enterprise Deception Platform · Ayush Anand</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
              MirageSentinel is an industrial-grade cybersecurity deception platform that deploys autonomous 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                From initial reconnaissance to lateral movement, MirageSentinel captures every 
                ...
                <div className="rounded-lg border border-border bg-background p-6">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold">MirageSentinel Dashboard</span>
                    </div>
                    <div className="flex items-center gap-2">
      ...
      <footer className="py-8 border-t border-border/50">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <Shield className="h-5 w-5 text-primary" />
              <span className="text-sm font-semibold">MirageSentinel_Deception_Lab</span>
